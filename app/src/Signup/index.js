...
class Signup extends Component {
   componentDidMount(){
    ...
    .then(response=>{
      $this.props.initialize({'reference':response.data.rewardCode})
    })
   }
              ...
              <div className="col-md-6">
                <div className="card mx-4">
                  <div className="card-block p-4">
                    ...
                    <label>推荐码</label>
                    <Field name="reference" type="text" labelIcon="icon-user" className="form-control" component={renderField} placeholder='如有推荐码，请在此填写推荐码。如没有,不用填写 ' />
