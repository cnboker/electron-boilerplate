...
class Form extends Component {
  ...
  submit(values) {
    ...
    var entity = R.mergeAll([this.props.entity, values, this.state,{keyword}]);
    console.log(entity)
  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit(this.submit.bind(this))}>
        ...
        <TextareaAutosize  rows={1} placeholder="输入需要优化的关键字,回车可以批量添加多个关键字" className="form-control" innerRef={ref => this.textarea = ref} />
        </RowContainer>
