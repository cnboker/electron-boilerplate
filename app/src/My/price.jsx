...
export default class Price extends Component {
  render() {
    ...
    const linkAction = this.props.action == undefined
      ? true
      : this.props.action;
    return (
              ...
              <div className="card-deck mb-3 text-center">
                <div className="card mb-4 box-shadow">
                  ...
                  <div className="card-body">
                    ...
                    {!authenticated && (
                      <Link to="/login" className="btn btn-lg btn-block btn-outline-primary">
                        注册
                      </Link>
                    )}
                  </div>
                ...
                <div className="card mb-4 box-shadow">
                  ...
                  <div className="card-body">
                    ...
                    {linkAction && (
                      <Link to="/contact" className="btn btn-lg btn-block btn-primary">
                        联系我们
                      </Link>
                    )}
                  </div>
