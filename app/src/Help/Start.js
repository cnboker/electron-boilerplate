    ...
    return (
      <div className="card">
        <div className="card-body">
          ...
          <p>
            SEO（搜索引擎优化）旨在通过搜索引擎获取更多流量。即通过对网站站内和站外的优化措施，让搜索引擎对目标网站更多收录，排序靠前，更好的展现。
            <br /> <br /> 网站被搜索引擎收录是前提。
          </p>
          <p>排序越靠前，获得展示和点击的机会越多。</p>
          <p>展现决定是否吸引点击进入目标网站。</p>
          <p>&nbsp;</p>
          <p>
            <strong>钢铁侠智能优化原理</strong>
          </p>
          <p>
            决定网页排名的影响有诸多，可大致分为三类：搜索引擎的排序算法、相似内容的竞争网页和目标网页的质量评分。钢铁侠系统针对搜索引擎的排序算法，通过多种有效方式提升目标网页的质量评分，从而实现目标网页的排序提升，帮助目标网站获得更好的展现机会。
            <br /> <br />{" "}
            推荐在站内优化的同时，使用钢铁侠SEO工具，会达到更好的优化效果。
            <br /> <br />{" "}
          </p>
          <p>
            <strong>一、快速入门</strong>
            <br />{" "}
            1、【新建】提交关键词和对应的目标网站；2、最小化并保持挂机连网状态；3、系统自动执行优化任务。
            <br /> <br /> 注：正常上下班开关电脑即可，无须刻意挂机。
          </p>
          <p>&nbsp;</p>
          <p>
            <strong>二、实用功能</strong>
          ...
          <p>
            <strong>4</strong>
            <strong>、智能优化</strong>
            &mdash;&mdash;集成多种有效提权方法（遵循搜索引擎许可规则），根据网站属性智能匹配组合优化方案，并根据效果反馈自动调整优化方案，以达到更好的优化效果。
          </p>
          <p>
            <strong>5</strong>
            <strong>、</strong>
          ...
          <p>
            <strong>6</strong>
            <strong>、智能拓词</strong>
            &mdash;&mdash;系统自动采集搜索量大的相关词。
          </p>
          <p>
            <strong>7</strong>
            <strong>、其它</strong>
            &mdash;&mdash;更多实用功能，即将在后续版本放出。
          </p>
          <p>
            <strong>
              <br />{" "}
          ...
          <p>
            ...
            <em>名以内的关键词进行优化处理。</em>
            <br /> <br />{" "}
            正常情况下，关键词提交后，保持软件运行状态，十分钟内会出现初始排名数据。如果一次提交关键词数量过多，时间会相对延长。
          </p>
          <p>
            <strong>情况</strong>
            <strong>1</strong>
          ...
          <p>
            如果提交多个关键词，只要有一个排名数据出现，即说明系统正常检测了。
          </p>
          <p>如果关键词排名数据长时间为0，那就可能是钢铁侠没有正常运行。</p>
          <p>
            有两个主要可能情况，一是有其它软件干扰，比如360安全软件；再就是操作系统不完整导致，比如有些精简版的操作系统可能缺少某个钢铁侠需要调用的系统文件。
          </p>
          <p>
          ...
          <p>3）升级操作系统到Win10或安装原版Windos7操作系统</p>
          <p>4）换一台电脑尝试</p>
          <p>
            据用户反馈，Win 10全面支持，Win 7原版全面支持，非原版Win 7
            存在个别版本不能正常运行。
          </p>
          <p>&nbsp;</p>
          <p>
          ...
          <p>
            注意，排名会受地域/网络环境/机型等用户的个性化因素影响产生差异，且某些关键词同一时间在不同地区，排名位置也可能不同。
          </p>
          <p>
            <strong>初始排名</strong>
