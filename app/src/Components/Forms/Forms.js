            ...
            <div className="card">
              <div className="card-header">
                ...
                <div className="card-actions">
                  <button  className="btn-setting"><i className="icon-settings"></i></button>
                  <button className="btn-minimize"><i className="icon-arrow-up"></i></button>
                  <button  className="btn-close"><i className="icon-close"></i></button>
                </div>
              </div>
              <div className="card-block">
